 ...
 * &lt;/fieldType&gt;</pre>
 */
public class CustomizedICUTokenizerFactory extends TokenizerFactory implements ResourceLoaderAware {
  static final String RULEFILES = "rulefiles";
  private final Map<Integer,String> tailored;
  private CustomizedDefaultICUTokenizerConfig config;
  
  /** Creates a new ICUTokenizerFactory */
  public CustomizedICUTokenizerFactory(Map<String,String> args) {
    super(args);
  ...
  public void inform(ResourceLoader loader) throws IOException {
    ...
    if (tailored.isEmpty()) {
      config = new CustomizedDefaultICUTokenizerConfig();
    } else {
