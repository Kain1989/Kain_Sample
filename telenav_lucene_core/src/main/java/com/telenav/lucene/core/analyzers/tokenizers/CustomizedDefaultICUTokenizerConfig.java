package com.telenav.lucene.core.analyzers.tokenizers;
/*
 ...
 * @lucene.experimental
 */
public class CustomizedDefaultICUTokenizerConfig extends ICUTokenizerConfig {
...
//  /** Token type for words that contain letters */
  ...
  private static final BreakIterator rootBreakIterator = 
    readBreakIterator(Constants.ONBOARD_SEARCH_RESOURCE_ROOT_PATH + "Default2.brk");
...
//    readBreakIterator("Myanmar.brk");
   ...
   */
  public CustomizedDefaultICUTokenizerConfig() {}
...
//        return script == UScript.HANGUL ? WORD_HANGUL : WORD_LETTER;
  ...
  private static RuleBasedBreakIterator readBreakIterator(String filename) {
    InputStream is = 
    		CustomizedDefaultICUTokenizerConfig.class.getClassLoader().getResourceAsStream(filename);
    try {
